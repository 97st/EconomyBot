...
module.exports = {
    ...
    async execute(interaction, profileData) {
        ...
        if (!userProfile) {
            userProfile = new profileModel({ userID: id, coinFlipLastUsed: 0, balance: 0 });
        }
        ...
        if (choice === result) {
            ...
            await interaction.editReply(`You won ${coinFlipReward} coins with **${choice}**!`);
        } else {
            await interaction.editReply(`Lost... You chose **${choice}** but it was **${result}**.`);
        }
    },
};
